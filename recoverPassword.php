...
if($_POST['submit'])
{
    ...
    {
        $ret = $doctorController->changeDoctorPassword($data);
...
<div class="container" style="margin-top: 130px;">
    <section class="login">
            ...
            <form action="recoverPassword.php" method="post" >
                ...
                <input type="text" required title="Email required" placeholder="Recovery Token" name="recoverytoken">
                <input type="password" required title="Email required" placeholder="New Password" name="password">
