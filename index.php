            ...
            foreach ($data as $d) 
            {
                ...
                <div class=\"thumbnail\" style=\"height: 380px; width: 250px;\">
                    ...
                    <div class=\"caption\">
                        ...
                        <p style=\"text-align: center;\"><a href=\"index.php?addToCart&pID=" . $d[3] . "\" class=\"btn btn-primary\" role=\"button\"><span class=\"glyphicon glyphicon-shopping-cart\" ></span> Add To Cart</a></p>
                    </div>
                </div>
            </div>";
