...
if($_POST['submit'])
{
    ...
    if($productController->editProduct($data) == "Successful")
    {
        ?>
...
<div class="container" style="margin-top: 130px;">
    <section class="login">
            <div class="titulo">Edit Product</div>
                <form action="editProduct.php" method="post" enctype="multipart/form-data">
                    ...
                    <button class="enviar" type="submit" value="Submit" name="submit">Update Product</button> 
                </form>
        </section>
</div>
