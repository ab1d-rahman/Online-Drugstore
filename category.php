    ...
    <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
            <div class="panel panel-default">
                <div class="panel-body">Product Category: <?php echo $category; ?></div>
            </div>
            ...
            if($_GET['category'])
            {
                ...
                <div class=\"thumbnail\" style=\"height: 380px; width: 250px;\">
                    ...
                    <div class=\"caption\">
                        ...
                        if($d[4]) echo"</p><p style=\"text-align: center;\"><a href=\"category.php?category=".$_GET['category']."&addToCart&pID=" . $d[3] . "\" class=\"btn btn-primary\" role=\"button\"><span class=\"glyphicon glyphicon-shopping-cart\" ></span> Add To Cart</a></p>";
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4" >
            ...
            <div class="list-group">
                <?php  
                if($_GET['category'] == 1) echo"<a href=\"category.php?category=1\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Anti-infectives</a>";
                else echo"<a href=\"category.php?category=1\" class=\"list-group-item\" style=\"font-weight: bold;\">Anti-infectives</a>";

                if($_GET['category'] == 2) echo"<a href=\"category.php?category=2\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Cough and Cold Relief</a>";
                else echo"<a href=\"category.php?category=2\" class=\"list-group-item\" style=\"font-weight: bold;\">Cough and Cold Relief</a>";

                if($_GET['category'] == 3) echo"<a href=\"category.php?category=3\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Diabetes Managements</a>";
                else echo"<a href=\"category.php?category=3\" class=\"list-group-item\" style=\"font-weight: bold;\">Diabetes Managements</a>";

                if($_GET['category'] == 4) echo"<a href=\"category.php?category=4\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Digestion and Nausea</a>";
                else echo"<a href=\"category.php?category=4\" class=\"list-group-item\" style=\"font-weight: bold;\">Digestion and Nausea</a>";

                if($_GET['category'] == 5) echo"<a href=\"category.php?category=5\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Eye, Nose and Ear Care</a>";
                else echo"<a href=\"category.php?category=5\" class=\"list-group-item\" style=\"font-weight: bold;\">Eye, Nose and Ear Care</a>";

                if($_GET['category'] == 6) echo"<a href=\"category.php?category=6\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Oral Care</a>";
                else echo"<a href=\"category.php?category=6\" class=\"list-group-item\" style=\"font-weight: bold;\">Oral Care</a>";

                if($_GET['category'] == 7) echo"<a href=\"category.php?category=7\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Pain and Fever Relief</a>";
                else echo"<a href=\"category.php?category=7\" class=\"list-group-item\" style=\"font-weight: bold;\">Pain and Fever Relief</a>";

                if($_GET['category'] == 8) echo"<a href=\"category.php?category=8\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Respiratory and Cardiovascular</a>";
                else echo"<a href=\"category.php?category=8\" class=\"list-group-item\" style=\"font-weight: bold;\">Respiratory and Cardiovascular</a>";

                if($_GET['category'] == 9) echo"<a href=\"category.php?category=9\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Skin Care</a>";
                else echo"<a href=\"category.php?category=9\" class=\"list-group-item\" style=\"font-weight: bold;\">Skin Care</a>";

                if($_GET['category'] == 10) echo"<a href=\"category.php?category=10\" class=\"list-group-item active\" style=\"font-weight: bold;\">
                Vitamins and Minerals</a>";
                else echo"<a href=\"category.php?category=10\" class=\"list-group-item\" style=\"font-weight: bold;\">Vitamins and Minerals</a>";
                ?>
            </div>
        </div>
    </div>  
